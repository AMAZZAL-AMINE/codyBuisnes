...
<head>
  ...
  <body style="margin: 0 !important; padding: 0 !important; background-color: #eeeeee;" bgcolor="#eeeeee">
      ...
      <tr>
        ...
        <![endif]-->
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:800px;">
                  ...
                  <table class="align-center" align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:800px;">
                    <tr>
                      <td align="left" height="48" valign="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size:48px; font-weight: 800; line-height: 48px;" class="mobile-center">
                        <h1 style="font-size: 0; line-height: 0; font-weight: 600;  margin: 0; color: #ffffff;"><img src="/img/coody.png" width="200" height="27" style="display: block; border: 0px;" alt="HealthPlanG" /></h1>
                      </td>
                    </tr>
                  </table>
                </div>
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" align="right">
                          <tr>
                            <td style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400;">
                              <p style="font-size: 18px; font-weight: 400; margin: 0; color: #23C467;"> <?php echo date('Y-m-d'); ?> </p>
                            </td>
                            <td  style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding-left: 10px;">
                                <span style="color:lightgreen"><i class="fas fa-clock "></i></span>
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <tr>
                    <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 10px;">
                      <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777; padding: 0 30px;">
                        Thank {{ auth()->user()->name }} for your order , I wish your order was verry easy
                      ...
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                          <td width="75%" align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 700; line-height: 24px; padding: 20px 10px 5px 10px;">
                            <span style="font-style: italic;">Quantity</span> 
                          </td>
            ...
            <tr>
              <td align="center" style=" padding: 35px; background-color: red;" bgcolor="#b91bAb">
                <!--[if (gte mso 9)|(IE)]>
                <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
                <tr>
                <td align="center" valign="top" width="600">
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                  <tr>
                    <td align="center" style="line-height: 0;">
                      <img src="/img/coody.png" width="200" height="27" style="display: block; border: 0px;" />
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="color: #ffffff; font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px;">
                      ...
                      -9.5830626 Agadir <br> Morocco 30.4211144
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px;">
                      <p style="font-size: 14px; font-weight: 400; line-height: 20px; color: #666666; padding: 0 25px; max-width: 400px;">
                          We Know there's anothers company in this world, we know there another website do like us, but we are #1 in our services ,.
                        <span style="color: #888888; display: block; font-size: 90%; font-weight: 600; padding-top: 15px;">© <?php echo date('Y') ?> Copyright: COODYBISNINS.com</span>
                      </p>
                    </td>
                  </tr>
                </table>
    ...
    <button onclick="display()" class="btn btn-primary w-100">Print This Invoice</button>
      <script>
         function display() {
            window.print();
         }
