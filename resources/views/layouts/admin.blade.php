  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">COODY Admin </div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ Route('admin.createproduct') }}">Create Product</a>
            <a class="collapse-item" href="{{ route('products.manager') }}">Manager Products</a>

                <hr>

            <h6 class="collapse-header">Custom Categories:</h6>
            <a class="collapse-item" href="{{ route('category.manager') }}">Manager Categories</a>
            <a class="collapse-item" href="{{ route('store.category') }}">Create Category</a>
          </div>
        </div>
      </li>
